...
from frontend.viewsets import UserViewSet, ProdukViewSet, KategoriViewSet, GambarProdukViewSet, ProvinsiViewset, RegencyViewset, DistricViewset, VillagerViewset, UserProfileViewset, UserAddressViewset
...
urlpatterns = [
    ...
    path('profile/alamat/<int:id_alamat>/delete', DeleteDetailProfile.as_view() ,name="delete_profile_detail"),
    ...
    path('transaksi/detail/<int:id>/ulasan', DetailTransaksiUlasan.as_view(), name="detail_transaksi_user_ulasan"),

    # toko
    path('toko/<int:id>/', Toko.as_view(), name="toko"),
    path('toko/<int:id>/list_produk/', ListProdukToko.as_view(), name="list_produk_toko"),
    path('toko/<int:id>/produk/<int:produk_id>/edit', EditBarang.as_view(), name="edit_barang"),
    path('toko/<int:id>/produk/<int:produk_id>/delete', ArchiveBarang.as_view(), name="delete_barang"),
    path('toko/<int:id>/alamat/', AlamatToko.as_view(), name="alamat_toko"),
    path('toko/<int:id>/alamat/<int:id_alamat>/delete', DeleteAlamatToko.as_view(), name="delete_alamat_toko"),
    path('toko/<int:id>/alamat/tambah', AlamatTokoTambah.as_view(), name="tambah_alamat_toko"),
    path('toko/<int:id>/withdrawl', WithdrawlToko.as_view(), name="withdrawl_toko"),
    path('toko/<int:id>/withdrawl/json', WithdrawlTokoJson.as_view(), name="withdrawl_toko_json"),
    path('toko/<int:id>/transaksi/', TransaksiToko.as_view(), name="transaksi_toko"),

    # user
    path('user/withdrawl/', Withdrawl.as_view(), name="withdrawl"),
    path('user/withdrawl/process/json', WithdrawlProcess.as_view(), name="widrawl_process"),
    path('user/withdrawl/request/process/json', WithdrawlRequestJson.as_view(), name="widrawl_request_process"),
    
    path('tambah/alamat/<int:id>/<str:type>', AlamatUser.as_view(), name="tambah_alamat_user"),
    ...
    path('address/user/<int:id>', DetailProfileAddressMain.as_view() ,name="address_userprofile"),
    ...
    path('transaksi/users/list/json', TransaksiUserJson.as_view(), name="transaksi_users_json"),
    path('transaksi/users/list/count/json', TransaksiUserCountJson.as_view(), name="transaksi_users_count_json"),
    path("transaksi/detail/json", DetailTransaksiJson.as_view(), name="detail_transaksi_user_json"),
    path('transaksi/users/selesai/json', TransaksiUserSelesaiJson.as_view(), name="transaksi_users_selesai_json"),
